...
namespace Pulumi.Proxmox
{
    public partial class Random : Pulumi.CustomResource
    {
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Random Get(string name, Input<string> id, RandomState? state = null, CustomResourceOptions? options = null)
        {
            return new Random(name, id, state, options);
        }
    }
    ...
    public sealed class RandomState : Pulumi.ResourceArgs
    {
        [Input("length")]
