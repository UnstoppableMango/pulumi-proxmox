...
namespace Pulumi.proxmox
{
    ...
    internal sealed class proxmoxResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public proxmoxResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
