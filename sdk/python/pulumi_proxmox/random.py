...
class Random(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, length=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, length=None, result=None):
        """
